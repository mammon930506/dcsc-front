	...
	<view class="wrap">
		...
		<scroll-view  scroll-y="true"  :style="{height:scrollViewHeight}">
			<view style="padding:0 40rpx">
				...
				<u-field :disabled="disabled" class="publishField" label-width="0" v-model.trim="form.idcardName"  placeholder="姓名" :border-bottom="false"></u-field>
				<view class="attrLabel">身份证</view>
				<u-field :disabled="disabled" @blur="validateId" class="publishField" label-width="0" v-model.trim="form.idcardNo"  placeholder="身份证" :border-bottom="false"></u-field>
				<view v-if="!ifrealname" class="attrLabel">银行卡号</view>
				<u-field v-if="!ifrealname" @blur="validateBankCode" class="publishField" label-width="0" v-model.trim="form.bankCode"  placeholder="银行卡号" :border-bottom="false"></u-field>
				<view class="attrLabel">手机号</view>
				<u-field disabled class="publishField" label-width="0" v-model.trim="form.phone"  placeholder="手机号" :border-bottom="false"></u-field>
				<view v-if="!disabled">
					<view class="attrLabel">验证码</view>
					<view style="display: flex;justify-content: space-between;align-items: center;">
						<u-field class="publishField" style="width:65%" label-width="0" v-model.trim="form.smsCode"  placeholder="验证码" :border-bottom="false"></u-field>
		...
		<view v-if="!disabled" style="position:fixed;bottom:0;width:100%;padding:30rpx;background-color:#18181c ;border-top:2rpx solid #59595D">
...
<script>
	...
	import {calScrollHeight,relogin} from "@/common/common.js"
